...
USERNAME = environ.get("USERNAME", "SpySpidey")
...
GRP_LNK = environ.get('GRP_LNK', 'http://telegram.me/+HngULuILtfVhYjY1')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002228771357')) #Log channel id ( make sure bot is admin )
